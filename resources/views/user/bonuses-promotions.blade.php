...
<div id="wrapper" class="cs">
    ...
    <div id="left">
        ...
        <table class="soc-2 share">
            <tr>
                <td class="soc-3">
                    <div class="fb-like" data-href="/operations/bonuses-promotions/"
                ...
                <td>
                    <a href="https://twitter.com/share" class="twitter-share-button"
                       data-url="/operations/bonuses-promotions/"></a>
                ...
                <td>
                    ...
                    <div class="g-plusone" data-size="medium" data-annotation="bubble" data-width="300"
                         data-href="/operations/bonuses-promotions/"></div>
                ...
                <div class="text_block-inner">
                    <div class="text_block-content">
                        <h2 style="text-align: center;">
                            自动出金</h2>
                        <p>
                            分分钟就可以出金？RoboforeForex非常考虑到客户宝贵的时间, 所以70%的出金申请都请 自动审核.
