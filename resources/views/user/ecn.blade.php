...
<head>
    ...
    <meta name="keywords" content="ecn, ecn broker,ecn交易,ecn平台" />
...
<div id="wrapper" class="cs">
    ...
    <div id="path">
        <a href="/" >首页</a>/<a href="/trade-conditions/account-types/" >条件</a>/专业ECN 账户
    </div>

    <div id="left">
        <h1 >来自ECN经纪商的专业 ECN 账户</h1>
        <table class="soc-2 share">
            <tr>
                <td class="soc-3">
                    <div class="fb-like" data-href="http://cn.roboforex.com/trade-conditions/ecn/" data-send="false" data-layout="button_count" data-width="82" data-show-faces="true"></div>
                    <div id="fb-root"></div>
                    <script>
                ...
                <td>
                    <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://cn.roboforex.com/trade-conditions/ecn/"></a>
                ...
                <td>
                    ...
                    <div class="g-plusone" data-size="medium" data-annotation="bubble" data-width="300" data-href="http://cn.roboforex.com/trade-conditions/ecn/"></div>
        ...
        <div ><style type="text/css">
            ...
            <p>
                <img src="/images/ecn-accounts-banner.jpg" style="width: 648px; height: 235px;" /></p>
            <h2>
                什么是ECN, 什么是ECN经纪商的主要特点?</h2>
            <p>
                ECN (电子通讯网络) 是一个电子交易网络, 客户之间在外汇市场交易时可省去第三方中介机构，由此每笔交易可以获得最优成交条件：交割速度快、点差低、价格最优化。</p>
            <!--p>
                <img src="/files/filemanager/image3/structure/trade-conditions/ecn/1%20copy.png" style="height: 197px; width: 648px;" /></p-->
            <p>
