...
<head>
    ...
    <title>"忠诚计划"</title>
    <meta property="og:title" content=""忠诚计划"" />
    <meta property="og:description" content="" />
    <meta property="og:url" content="/forex-affiliate/loyalty-program/" />
...
<div id="wrapper" class="cs">
    ...
    <div id="left">
        ...
        <div ><style type="text/css">
            ...
            <p>
                <img alt="" src="/images/loyalty_program_bz.png" style="width: 648px; height: 225px;" /></p>
            <p>
                GoldMany代理的&quot;忠诚计划&quot;可将您的佣金收益增加20%. 参加该计划的合作代理可就每月返佣金额获取额外百分比奖励. </p>
            <div style="margin-bottom:15px;">
                <p style="display:inline-block;width: 30%;font-size: 17px;text-align: center;margin-bottom: 10px; color:#2d759d;">
                    您的利润</p>
                <p style="display:inline-block;width: 30%;font-size: 17px;text-align: center;margin-bottom: 10px; color:#2d759d;">
                    回报百分比%</p>
                <p style="display:inline-block;width: 30%;font-size: 17px;text-align: center;margin-bottom: 10px; color:#2d759d;">
                ...
                <div style="display:inline-block;width: 30%;font-size: 17px;text-align: center;vertical-align: middle;">
                    从 500<br />
                    到 5,000 USD</div>
                <div style="display:inline-block;  width: 30%;text-align: center;">
                    <p style="border: 4px dotted #2d759d; line-height: 60px; border-radius: 50%;font-size: 25px;width: 60px;color: #2d759d;margin: 10px auto;">
                        5%</p>
                </div>
                <div style="display:inline-block;  width: 30%;text-align: center;vertical-align: middle;">
                    <p style="font-size: 17px; margin-bottom: 0px;">
                        <i class="fa fa-usd" style="color:#2d759d; font-size: 25px; margin-bottom: 10px;">&nbsp;</i><br />
                        最高至 250 USD</p>
                </div>
                <hr style="margin: 5px 0;" />
                <div style="display:inline-block;width: 30%;font-size: 17px;text-align: center;vertical-align: middle;">
            ...
            <p>
                &quot;忠诚计划&quot;奖励每月自动打入满足条件的代理账户, 每月有机会获得6,000美元以上的额外收益!</p>
