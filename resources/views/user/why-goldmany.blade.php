...
<head>
    ...
    <title>为什么 选择GoldMany</title>
    <meta property="og:title" content="为什么 选择GoldMany" />
    <meta property="og:description" content="" />
    <meta property="og:url" content="http://cn.GoldMany.com/about/why-GoldMany/" />
...
<div id="wrapper" class="cs">
    ...
    <div id="path">
        <a href="/" >首页</a>/<a href="/about/" >关于GoldMany</a>/为什么选择GoldMany
    </div>
...
">
                    ...
                    <ul class="reasons">
                        ...
                        <li>
                            即时订单执行</li>
                        <li>
                            <a href="/trade-conditions/account-types" target="_blank">3种类型的交易账户</a></li>
                        <li>
                            差价合约交易 (CFD)</li>
                        <li>
                            没有最小存款</li>
                        ...
                        <li>
                            <a href="/operations/bonuses-promotions/1000-up-leverage/" target="_blank">杠杆1:100</a></li>
...
">
                    ...
                    <ul class="reasons">
                        <li>
                            Gold Many Global Ltd受到Vanuatu监管, 执照号14668.</li>
                        {{--<li>--}}
                            {{--并且GoldMany (CY) Ltd 是塞浦路斯--}}
                            {{--<a href="https://my.robofx.com/files/document/information_on_investor_compensation_scheme.pdf" target="_blank">投资者赔偿基金</a>会的一名正式会员, 可为投资者提供高达20,000欧元存款的保险&nbsp;</li>--}}
                        {{--<li>--}}
